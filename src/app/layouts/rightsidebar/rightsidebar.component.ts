...
import { getLayout, getLayoutTheme, getLayoutWidth, getLayoutmode, getPosition, getPreloader, getSidebarcolor, getSidebarsize, getTopbar, getsidebarimage, getsidebarview } from '../../store/layouts/layout-selector';
import { changeMode, changeTheme, changelayoutTheme, changeposition, changepreLoader, changesidebarImage, changesidebarView, changesidebarcolor, changesize, changetopbar, changewidthLayout } from '../../store/layouts/layout-action';
import { MENU } from '../sidebar/menu';
import { take } from 'rxjs/operators';
import { RootReducerState } from '../../store';
import { LayoutState, initialState } from '../../store/layouts/layout-reducers';
